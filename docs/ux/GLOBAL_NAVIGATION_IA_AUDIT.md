...
Date: 2026-09-16
Status: Option A approved; bottom-tab migration deferred

## Current State

The current bottom tabs are Today / Ledger / Capture / Trip. The only top-left
menu is currently attached to the Ledger root and repeats Trip, Ledger, and
Capture before Settings and Language. Capture is a lightweight routing-boundary
screen and has no persistent product content state beyond its route. Removing
it from the tab bar later requires a global creation trigger and preservation of
receipt/manual Expense entry routes; that migration is outside this task.
