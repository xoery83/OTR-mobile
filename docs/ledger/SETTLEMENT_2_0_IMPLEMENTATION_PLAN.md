...
**UI.** Continuous Summary | Spending | Shares | Payments sections; horizontally scrollable secondary navigation becomes sticky under Ledger header; tap scrolls vertically, no full-page horizontal swipe. Summary leads with own current/final balance, paid-for-group/share explanation, affected delta and actionable versus automatic waiting. Spending and Shares default to Me, organizer may choose a member; expandable categories show payer, original/shared amounts and Expense detail link. Payments defaults Mine; organizer may view Everyone, with canonical recommended transfers separate from owner and counterparty records. Reuse Review deep links and intentionally opened personal statement. First pass prioritizes correct hierarchy, permissions and tap paths; visual polish follows device feedback.
