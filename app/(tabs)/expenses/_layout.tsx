  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        ...
        options={{ headerTitle: "Correct Confirmed Expense" }}
      />
      <Stack.Screen
        name="settlement-update"
        options={{ headerTitle: "Review Settlement Changes" }}
      />
      <Stack.Screen
      ...
      <Stack.Screen name="settings" options={{ headerTitle: "Currency" }} />
      <Stack.Screen name="currency" options={{ headerTitle: "Currency" }} />
